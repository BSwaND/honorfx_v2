...
class UFormConfig
{
    ...
    public $fromMail = 'honorfx@smartmail.club'; // Ваш Email, с которого отправляется письма (если используется SMTP, крайне желательно, чтоб совпадал с email-ом SMTP)
    public $receiverMails = 'support@honorfx.com'; // Email получателей
    ...
    public $smtp = [
        'username' => 'honorfx@smartmail.club',
        'password' => 'ENDUdz9dfgRaKM',

        // this is the default for *** smtp
