...
$inputs = [
    'uForm_1' => [ // id формы
        'name' => ['lenStr' => [2, 50, false]],
        'lastName' => ['lenStr' => [2, 50, false]], // lenStr - название проверочной функции, 2 и 50 - аргументы передаваемые в функцию (мин и макс символов), true - обризать лишний текст (иначе удаляет все содержимое)
...
$requires = [
    'uForm_1' => ['name', 'lastName', 'email', 'tel'],
    'uForm_2' => ['name', 'lastName', 'email', 'tel'],
];
